...
<style type="text/css">
	...
	td {
		...
		<meta property="og:url" content="./index.php?id=<?php echo $pName ?>"> 
	<script>
	...
	<body>
			<div id="container">
			<div id="header">
				<a href="./index<?php echo '?id='.$pName; ?>" id="logo"><?php echo $title ?></a>
			</div>
			<div id="navigation">
				<a href="./index<?php echo '?id='.$pName; ?>">Vote</a>
				<a href="./index<?php echo '?id='.$pName; ?>#top-rankers">Top 10</a>
				<a href="about">Info</a>
			</div>
			<div class="clear"></div>
...
<form action="./rate" method="post">
	...
	<div class="half">
		<div class="holder" style="float: right; width=400px;">
			<img src="tm/upload/<?php echo $images[0]->filename ?> "  height='400' />
...
<form action="./rate" method="post">
	...
	<div class="half">
		<div class="holder" style="float: left; width:400px;">
			<img src="tm/upload/<?php echo $images[1]->filename ?> "  height='400' />
...
<table>
	<tr>
		...
		<td valign="top"><img src="tm/upload/<?php echo $image->filename ?>" width="70" /></td>
		<?php endforeach ?>
	</tr>
	<tr>
		<?php $rank=1; foreach($top_ratings as $key => $image) : ?>
